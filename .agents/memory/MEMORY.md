...
- [12-agent office system](agent-system-v3.md) — 12 agents: original 9 + researcher/deployer/reviewer; collab thread system in-memory; conference table shows in SVG when threads active; never use backticks inside template literals in agent-workers.ts (esbuild breaks)
